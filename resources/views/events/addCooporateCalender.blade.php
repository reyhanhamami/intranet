...
@section('title', 'Intranet - Add Cooporate event')

<!-- start template -->
<div class="container-fluid">
    @section('judul', 'Add Cooporate event')
    @section('sub', 'BWA')
        ...
        <div class="row ">
            <div class="col-12 ">
                <div class="card shadow border-left-success container">
                    <form action="{{ route('events.storecooporatecalender') }}" method="post" enctype="multipart/form-data">
                    @csrf
